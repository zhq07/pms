...
//    }
    ...
    public OptResult simData() {
        List<Task> taskList = pmsTaskService.getTaskListByPmsTasksAndTaskLinksAndtaskGroups(pmsTaskList, pmsTaskLinkList, pmsTaskGroupList, new ArrayList<PmsGroup>());
        // 真紧前任务，为前端甘特图用
